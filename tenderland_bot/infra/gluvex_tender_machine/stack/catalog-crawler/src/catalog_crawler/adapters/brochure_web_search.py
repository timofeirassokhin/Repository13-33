...
VENDOR_CONFIGS: dict[str, VendorSearchConfig] = {
    ...
    "Burning Rock Dx": VendorSearchConfig(
        brand="Burning Rock Dx",
        brand_slug="burning_rock",
        vendor_sites=["brbiotech.com"],
        distributor_sites=[],
        search_brand_names=["Burning Rock", "Burning Rock Dx"],
    ),
    "Hawach Scientific": VendorSearchConfig(
        brand="Hawach Scientific",
        brand_slug="hawach",
        vendor_sites=["hawach.com", "en.hawach.com"],
        distributor_sites=[],
        search_brand_names=["Hawach", "Hawach Scientific"],
    ),
    "Memmert": VendorSearchConfig(
        brand="Memmert",
        brand_slug="memmert",
        vendor_sites=["memmert.com"],
        distributor_sites=["nrglobal.com"],
        search_brand_names=["Memmert"],
    ),
    "memmert": VendorSearchConfig(
        brand="memmert",
        brand_slug="memmert",
    ...
    "CAMAG": VendorSearchConfig(
        brand="CAMAG",
        brand_slug="camag",
        vendor_sites=["camag.com"],
        distributor_sites=[],
        search_brand_names=["CAMAG"],
    ),
    "Liebherr": VendorSearchConfig(
        brand="Liebherr",
        brand_slug="liebherr",
        vendor_sites=["home.liebherr.com", "liebherr.com"],
        distributor_sites=[],
        search_brand_names=["Liebherr"],
    ),
    "Shinko Denshi (Vibra)": VendorSearchConfig(
        brand="Shinko Denshi (Vibra)",
        brand_slug="vibra",
        vendor_sites=["vibra.co.jp", "shinko-denshi.com"],
        distributor_sites=[],
        search_brand_names=["Vibra", "Shinko Denshi", "ViBRA"],
    ),
    "SCHMIDT&HAENSCH": VendorSearchConfig(
        brand="SCHMIDT&HAENSCH",
        brand_slug="schmidt_haensch",
        vendor_sites=["schmidt-haensch.com", "schmidt-haensch.de"],
        distributor_sites=[],
        search_brand_names=["Schmidt+Haensch", "Schmidt & Haensch", "S+H"],
    ),
    "HTA_2025": VendorSearchConfig(
        brand="HTA_2025",
        brand_slug="hta",
